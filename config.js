...
module.exports = {
  ...
  ownerNumber: (process.env.OWNER_NUMBER || '2250710227786').split(','), // Support multi-owner via virgule
  phoneNumber: process.env.OWNER_NUMBER || '2250710227786', // Pour pairing code
